...
static void InitConio2(Conio2ThreadData *data) {
	...
	SetConsoleMode(data->input, ENABLE_PROCESSED_INPUT); //THIS LINE BLOCKS std::cin DISPLAY WRITTEN LETTERS!!! "IXI"
	UpdateWScroll();
	//	SetConsoleOutputCP();
	//SetConsoleMode(data->output, ENABLE_PROCESSED_OUTPUT | ENABLE_WRAP_AT_EOL_OUTPUT); //THIS WRAPS LINES OF TEXT "IXI"
};
